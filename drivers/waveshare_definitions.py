...
# synonym to the above when the Pot jumper is out
EXT0 = POS_AIN0|NEG_AINCOM
# Light dependant resistor of the same board:
LDR  = POS_AIN1|NEG_AINCOM
# synonym to the above when the Optical resistor jumper is out
...
AD_CHANNEL_MAP = {
    '0': EXT0, '1': EXT1, '2': EXT2, '3': EXT3, '4': EXT4, '5': EXT5, '6': EXT6, '7': EXT7
}
...
# These are reasonable guesses for 100mv starting point
ONE_HUNDRED_MV_HIGH = 0x7ff
ONE_HUNDRED_MV_START = 0x7d0
ONE_HUNDRED_MV_LOW = 0x7c0

# These are reasonable guesses for 1v starting point
ONE_V_HIGH = 0x4cd7f
ONE_V_START = 0x4cfd
ONE_V_LOW = 0x4ce0

# These are reasonable guesses for 2v starting point
TWO_V_HIGH = 0x9a00
TWO_V_START = 0x99d5
TWO_V_LOW = 0x9900

# For calculating. This will be a low estimate
ONE_HUNDRED_MV_INCREMENT = 0x7A0